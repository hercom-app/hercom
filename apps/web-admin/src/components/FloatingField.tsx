...
const fieldClass =
  "peer w-full rounded-lg border border-slate-200 bg-white px-3.5 pb-2.5 pt-5 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-transparent focus:border-hercom focus:ring-2 focus:ring-hercom/20";
